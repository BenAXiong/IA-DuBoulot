...
- disabled student-rail placeholders align their labels on the icon row and reserve a second description line that fades in only on hover; hover must not change row height or push neighboring rail items
