...
- the root Homework page keeps all subject shortcuts unselected on entry and lists recent chats across all subjects by latest activity. A compact vertical-ellipsis shortcut editor controls browser-local default-subject visibility, drag order, and custom subject labels without changing canonical conversation subjects.
