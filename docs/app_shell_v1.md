...
- the landing-specific header uses that Student, Parent, or Tutor identity selector as its center control instead of generic Product/Features/Pricing anchors. Pricing now lives inside a compact `?` menu beside the theme toggle, alongside a temporary FAQ placeholder.
