...
- Current version: `student-coach-v7`
...
- Routes or workflow: POST /api/uploads/confirm; POST /api/subject-resources/confirm
- Aim: Extract readable homework or subject-resource text and basic metadata from uploaded files.
- Expected outcome: Returns JSON with extractedText, detectedLanguage, confidenceScore, needsManualReview, pageCountEstimate, sourceSummary, and a section-first optional sourceOutline.
