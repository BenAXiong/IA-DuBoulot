...
| 2026-03-13 | 12:27 -> OPEN | OPEN | A0.3.7 A7.4.7 P1.1 P1.3 | reopen after the auth viewport-fit pass, shrink `/auth` into a compact HUD-style entry, tighten the auth cards, and align placeholder copy with public-facing product suggestions |
