...
| A5.4.3 | A6.3.3 | xx% | GPT-5.4 | Extra High | / | Speed option removed & quota not updating |
| A6.3.3 | x | xx% | GPT-5.4 | Extra High | Fast | |
...
| 2026-03-11 | 13:48 -> OPEN | OPEN | A6.2.1 A6.2.2 A6.2.3 A6.3.1 A6.3.2 A6.3.3 A6.4.1 A6.4.2 A6.4.3 | phase A6 context rebuild + usage counters, trial/quota enforcement, billing abstraction, deployed Lemon test-mode verification, and privacy/settings deletion controls |
