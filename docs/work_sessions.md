...
| 2026-05-13 | 09:17 -> OPEN | OPEN | A0.3.7 A2.1.1 A2.2.3 P1.3 P2.6 | reopen the current execution trace after closing the 2026-05-12 evening settings and signup-validation session, then simplify auth/onboarding chrome and persist the new learner onboarding fields |
