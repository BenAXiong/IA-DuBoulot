...
| 2026-05-31 | 00:03 -> OPEN | OPEN | A0.3.7 P4.2 | reopen the current execution trace, archive older work-session plus prompt-log rows, split Pilot_todo into a board plus focused detail docs, and record the doc-only no-push convention |
