...
| A6.4.3 | x | xx% | GPT-5.4 | Extra High | / | |
...
| 2026-03-11 | 13:48 -> OPEN | OPEN | A6.1.1 A6.1.2 A6.1.3 A6.1.4 A6.2.1 A6.2.2 A6.2.3 A6.3.1 A6.3.2 A6.3.3 A6.4.1 A6.4.2 A6.4.3 | phase A6 context rebuild + usage counters, trial/quota enforcement, billing abstraction, deployed Lemon test-mode verification, privacy/settings deletion controls, and student memory profile work |
