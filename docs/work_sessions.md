...
| 2026-05-12 | 15:15 -> OPEN | OPEN | A0.3.7 P1.3 P2.4 | close the 2026-05-11 execution trace at 19:30, reopen the current work session, synchronize Homework subject selection into the URL without route loading, resync the selected subject when external rail links change the subject URL, intercept same-page Homework rail subject clicks for instant local switching, and lazy-load subject-resource libraries per selected subject |
