...
| 2026-04-28 | 15:39 -> OPEN | OPEN | A0.3.7 P1.3 P2.7 | restart the execution trace for the PDF-preview slice, then continue into subject-wide resource storage, deterministic chunking, and retrieval v1 |
