...
| 2026-04-29 | 15:50 -> OPEN | OPEN | P2.7.10 P2.7.11 P2.7.12 | restart after closing the 2026-04-29 subject-resource UI session, then improve PDF and subject-resource outline formatting, tune upload validation/caps, and implement resource lifecycle controls |
