...
| 2026-05-06 | 16:59 -> OPEN | OPEN | A0.3.7 P1.3 P2.7 | cancel the mistaken 2026-05-05 22:34 reopen, open a fresh execution trace, tune the student left-rail activity sequence, correct the Dashboard/disabled-section rail styling, add subject recent-chat expanders, try hover-revealed future-section descriptions without rail height shifts, and polish subject-resource card controls |
