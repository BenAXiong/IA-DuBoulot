...
| 2026-03-10 | 20:05 -> OPEN | OPEN | A0.1.1 A0.1.2 A0.1.3 A0.1.4 A0.1.5 A0.2.1 A0.2.5 A0.2.6 A0.4.1 A0.4.3 A0.4.4 A1.1.1 A1.1.2 A1.1.3 A1.1.4 A1.1.5 A1.2.1 A1.2.2 A1.2.3 A1.2.4 A1.3.1 A1.3.2 A1.3.3 A1.3.4 A1.4.1 A1.4.2 A1.4.3 A2.1.1 A2.1.2 A2.1.4 A2.1.5 A2.2.1 | project decisions + bootstrap + vercel + governance docs + under-13 baseline + next scaffold + hosted schema/RLS apply + backend contract docs + error/audit + storage rules + SSR auth bootstrap routes + deterministic fixture seed/RLS verification pass + sample attachment corpus + user-facing auth wiring |
