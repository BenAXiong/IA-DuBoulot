...
| 2026-04-28 | 15:39 -> 16:22 | 0h43 | A0.3.7 P1.3 P2.7 | restart the execution trace for the PDF-preview slice, add the lightweight PDF details dropdown, add optional extraction outline metadata, and tighten PDF detail microcopy |
| 2026-04-28 | 21:56 -> 23:16 | 1h20 | P2.7 | resume subject-wide upload work, document the plan, add durable subject resources, deterministic chunking, retrieval v1, and the late-page retrieval fixture |
| 2026-04-29 | 10:25 -> 11:56 | 1h31 | A0.3.7 P2.7 P2.7.6 P2.7.7 P2.7.8 P2.7.9 P6.1 | reopen the execution trace after closing the 2026-04-28 evening subject-wide upload slice, review remaining P2.7 work, reorganize subject-wide upload tasks, verify hosted subject-resource RLS, add subject-doc decision gates, and implement subject-doc library, selection UI, and subject-page tabs |
| 2026-04-29 | 15:50 -> 18:03 | 2h13 | P2.7.10 P2.7.11 P2.7.12 | restart after closing the 2026-04-29 subject-resource UI session, then improve PDF and subject-resource outline formatting, tune upload validation/caps, implement resource lifecycle controls, and add retrieval measurement |
| 2026-04-29 | 22:12 -> 22:23 | 0h11 | A0.3.7 P1.3 P2.7 P2.7.9 P3.3 P6.1 P6.2 P6.3 P6.4 P6.5 | restart the execution trace after closing the P2.7.10-P2.7.12 subject-resource session, log post-pilot subject-resource follow-ups, inspect the failed Sésamath workbook extraction, and isolate subject-page tab content |
| 2026-04-30 | 08:53 -> 11:13 | 2h20 | A0.3.7 P1.3 P2.7 P2.7.8 P2.7.9 P2.7.10 P2.7.12 P6.1 P6.2 P6.3 P6.4 P6.5 | reopen the execution trace after closing the 2026-04-29 evening session, fix subject-page tab behavior, polish subject-resource previews and caps, document the subject-doc feature, add first-prompt subject-doc preselection, and log remaining Pilot closure work |
...
| 2026-05-06 | 16:59 -> OPEN | OPEN | A0.3.7 P1.3 P2.7 | cancel the mistaken 2026-05-05 22:34 reopen, open a fresh execution trace, tune the student left-rail activity sequence, correct the Dashboard/disabled-section rail styling, add subject recent-chat expanders, try hover-revealed future-section descriptions without rail height shifts, polish subject-resource card controls, and disable subject-resource uploads when the account upload quota is exhausted |
