...
| 2026-04-04 | 10:22 -> OPEN | OPEN | A0.3.7 P1.1 P1.3 P2.1 P2.4 | reopen the execution trace for today, then redesign the student `/app` shell into a chat-first learner workspace, move learner-owned support controls into settings, simplify the intake and conversation surfaces, and log the deferred subject-model or implicit-creation decisions for Pilot |
