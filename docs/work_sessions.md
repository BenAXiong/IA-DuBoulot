...
| 2026-04-30 | 20:34 -> OPEN | OPEN | A0.3.7 P1.3 P2.7 P6.6 P6.7 P6.8 | reopen the execution trace after closing the 2026-04-30 morning subject-doc session, continue subject-doc cap, validation, workspace resource UI polish, and close the first subject-doc feature version with remaining follow-ups moved to P6 |
