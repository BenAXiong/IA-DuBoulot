...
| 2026-04-06 | 13:11 -> OPEN | OPEN | A0.3.7 | resync the execution trace by splitting the 2026-04-04 afternoon session into two canonical rows and reopen a fresh session for today |
