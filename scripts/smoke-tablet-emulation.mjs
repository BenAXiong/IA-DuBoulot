    ...
    pages: [
      {
        ...
        path: "/app",
        selectors: [
          "text=Point de départ élève",
          "role=link[name=\"Nouveau devoir\"]",
          "text=Sessions récentes",
          "text=Mémoire pédagogique",
        ],
        criticalTargets: ["Nouveau devoir"],
      },
      {
        name: "new-homework",
        path: "/app/new",
        selectors: [
          "text=Titre du devoir",
          "text=Sources du devoir",
          "text=Texte extrait relu",
          "role=button[name=\"Créer la session\"]",
        ],
        criticalTargets: ["Créer la session", "Régénérer le brouillon"],
      },
      {
        name: "conversation",
        path: `/app/conversations/${FIXTURE.ids.conversation}`,
        selectors: [
          "text=Plan de résolution",
          "text=Notes élève + références de pièces",
          "role=button[name=\"Sauvegarder\"]",
          "role=button[name=\"Envoyer\"]",
        ],
        criticalTargets: ["Sauvegarder", "Envoyer"],
      },
    ],
  },
  en: {
    ...
    pages: [
      {
        ...
        path: "/app",
        selectors: [
          "text=Student starting point",
          "role=link[name=\"New homework\"]",
          "text=Recent sessions",
          "text=Pedagogical memory",
        ],
        criticalTargets: ["New homework"],
      },
      {
        name: "new-homework",
        path: "/app/new",
        selectors: [
          "text=Homework title",
          "text=Homework sources",
          "text=Reviewed extracted text",
          "role=button[name=\"Create session\"]",
        ],
        criticalTargets: ["Create session", "Regenerate draft"],
      },
      {
        name: "conversation",
        path: `/app/conversations/${FIXTURE.ids.conversation}`,
        selectors: [
          ...
          "text=Student notes + attachment references",
          "role=button[name=\"Save\"]",
          "role=button[name=\"Send\"]",
        ],
        criticalTargets: ["Save", "Send"],
      },
    ],
  },
  zh: {
    ...
    pages: [
      ...
      },
      {
        ...
        selectors: [
          ...
          "text=作業來源",
          "text=重讀後的擷取文字",
          "role=button[name=\"建立課程\"]",
        ],
        criticalTargets: ["建立課程", "重新產生草稿"],
      },
      {
        name: "conversation",
        path: `/app/conversations/${FIXTURE.ids.conversation}`,
