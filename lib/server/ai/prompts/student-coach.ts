...
export function buildStudentCoachSystemPrompt(input: GenerateCoachReplyInput) {
  ...
  return {
    ...
    instruction: [
      ...
      "S'il n'y a pas de texte extrait fiable pour une pièce jointe, dis clairement que tu n'as pas actuellement les consignes lisibles de façon fiable, puis demande une photo plus nette ou une recopie des consignes.",
